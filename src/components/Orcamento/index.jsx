...
function Orcamento() {
  ...
  return (
    <section className="min-h-screen bg-black flex items-center justify-center p-6 flex-col">
      {/* Logo */}
      <div className="rounded-lg relative w-full h-[50px] mb-[50px] flex items-center left-14">
        <BrandWhite />
      </div>
      <div className="bg-black max-w-4xl w-full rounded-2xl border border-black p-8 text-[#d9d9d9] space-y-8">
        {/* Texto à direita justificado */}
        <div className="flex flex-wrap justify-between items-start gap-4">
          <div className="flex-1" /> {/* espaço vazio à esquerda */}
          <div className="max-w-sm text-[15px] leading-[1.4] font-glacial text-right text-justify">
